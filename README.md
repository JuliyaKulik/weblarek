...
setSelectedProduct(products: IProduct): void - сохранение товара для подробного отображения;
...
addProductInCart(product: IProduct): void - добавление товара в массив корзины;
removeProductInCart(product: IProduct): void - удаление товара из массива корзины;
getTotalPrice(): number - получение стоимости всех товаров в корзине;
getTotalProductsInCart(): number - получение количества товаров в корзине;
